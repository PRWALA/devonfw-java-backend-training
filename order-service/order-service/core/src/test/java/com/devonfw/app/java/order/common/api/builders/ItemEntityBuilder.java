package com.devonfw.app.java.order.common.api.builders;
...
public class ItemEntityBuilder {
   ...
   */
  public ItemEntityBuilder orderPositions(final Set<ItemEntity> orderPositions) {
  ...
  public ItemEntity createNew() {
    ...
    for (Consumer<ItemEntity> parameter : this.parameterToBeApplied) {
